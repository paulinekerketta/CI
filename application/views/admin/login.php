...
<html lang="en">
   <head>
      ...
      <meta charset="utf-8" />
      <title>Login - Human Behaviour Admin</title>
                  ...
                  <div class="login-container">
                     <div class="center">
                        <h1>
                           ...
                           <img src="<?php echo base_url();?>assets/images/logo_new_2.png" width="20%">
                           <span class="red">Human Behaviour</span>
                        ...
                        <div id="forgot-box" class="forgot-box widget-box no-border">
                           <div class="widget-body">
                              <div class="widget-main">
                                 ...
                                 <form method="post" action="<?php echo base_url();?>admin_forgot_password">
                                    <fieldset>
                                       <label class="block clearfix">
                                       <span class="block input-icon input-icon-right">
